...
Version  : 1.7.16
Release  : 109
URL      : https://cran.r-project.org/src/contrib/e1071_1.7-16.tar.gz
Source0  : https://cran.r-project.org/src/contrib/e1071_1.7-16.tar.gz
...
%setup -q -n e1071
pushd ..
cp -a e1071 buildavx2
popd
pushd ..
cp -a e1071 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726520938
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/e1071/libs/e1071.so
/V4/usr/lib64/R/library/e1071/libs/e1071.so
